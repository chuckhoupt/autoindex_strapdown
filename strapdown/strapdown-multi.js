...
;(function(window, document) {
  ...
  var xmpEls = document.getElementsByTagName('xmp');
  var markdownEls = xmpEls.length ? xmpEls : document.getElementsByTagName('textarea'),
      firstMarkdownEl = markdownEls[0],
  ...
  // Get theme
  var theme = FirstMarkdownEl.getAttribute('theme') || 'bootstrap';
